...
</div>` }, { id: "floating-dock-nav", title: "Floating Dock Nav", type: "ui", demo: "./snippets/floating-dock-nav/demo.html", thumb: "", summary: "A pill-shaped nav bar floats at the bottom of the screen with icon tabs and a solid CTA button.", description: "Taken from the navigation pattern on Krish Kasodariya's portfolio. Stays fixed as the user scrolls, picks up a subtle background on scroll, and contains icon-only links on the left and a solid call-to-action pill on the right.", bestFor: "Portfolios, single-page sites, mobile-first layouts, and product landing pages.", usage: [ "Paste the nav HTML and CSS at the very bottom of your body, above the closing tag.", "Replace each SVG icon with your own and update the href values to your section IDs or pages.", "Change the CTA button text and link to point at your contact form or booking page." ], fallback: ` <div class="thumb-surface"> <div class="thumb-pill-row"> <span class="thumb-pill">Nav</span> <span class="thumb-pill is-muted">CTA</span> </div> </div> `, code: `<style>
.snc-dock {
  position: fixed;
  bottom: 24px;
  left: 50%;
...
.snc-phones-btn:hover { background: #f0f0f0; }
...
<\/script>`}, { id: "scroll-to-top", title: "Scroll To Top", type: "ui", demo: "./snippets/scroll-to-top/demo.html", thumb: "", summary: "A floating button appears after scrolling and smoothly jumps back to the top.", description: "This keeps long pages easier to navigate without locking a permanent button into your layout. It is especially useful when a page has a lot of stacked sections or content blocks.", bestFor: "Sales pages, portfolios, documentation, tutorials, and long landing pages.", usage: [ "Keep the fixed button markup and the scroll listener together so the visibility state stays synced.", "Change the scroll threshold if you want the control to appear sooner or later on the page.", "Use the same pattern for other floating utilities like chat launchers or quick action buttons." ], fallback: ` <div class="thumb-surface"> <div class="thumb-scroll-lines"> <div class="thumb-scroll-line"></div> <div class="thumb-scroll-line mid"></div> <div class="thumb-scroll-line short"></div> <div class="thumb-scroll-line"></div> </div> <div class="thumb-arrow-badge">&#8593;</div> </div> `, code: `<style> .snc-scroll-top { position: fixed; right: 1.5rem; bottom: 1.5rem; width: 52px; height: 52px; border: 0; border-radius: 999px; background: linear-gradient(135deg, #28ff0d, #28ff0d); color: #0171d3; font-size: 1.1rem; box-shadow: 0 0 30px rgba(40, 255, 13, 0.35); opacity: 0; pointer-events: none; transition: opacity 0.25s ease, transform 0.25s ease; } .snc-scroll-top.is-visible { opacity: 1; pointer-events: auto; } </style> <button class="snc-scroll-top" id="sncScrollTop" aria-label="Scroll to top">&#8593;</button> <script> const sncScrollTop = document.getElementById("sncScrollTop"); window.addEventListener("scroll", () => { sncScrollTop.classList.toggle("is-visible", window.scrollY > 240); }); sncScrollTop.addEventListener("click", () => { window.scrollTo({ top: 0, behavior: "smooth" }); }); <\/script>` } ];
